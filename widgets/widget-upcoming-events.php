  ...
  **/
  function widget( $args, $instance ) {
    ...
    **/
    ...
    $cortex_time = date('Ymd', current_time( 'timestamp' ) );
    $event_end_date = date('Ymd', strtotime($cortex_time. ' + 2 days' ));
    ...
    if ($cat_name == '') { // all posts
      $cortex_upcoming_events = new WP_Query(
        array(
          ...
          'meta_key'               => 'date_1', // your ACF Date & Time Picker field
          'meta_value'             => $event_end_date, // Use the current time from above
